...
const gameState = {
    ...
    tanks: {
        ...
        tk04: { name: "HDR 04 FO Servico BB", type: 'fo_hdr', max: 15.0, vol: 0 },
        tk05: { name: "HDR 05 FO Servico BE", type: 'fo_hdr', max: 15.0, vol: 0 },
    ...
    machinery: {
        ...
        fifi: {
            ...
            oilPress: 0,
            coolTemp: 30,
            seawaterChestOpen: false,
            shellValveOpen: false,
            monitorsCommandOpen: false,
            monitorDelaySeconds: 0,
            monitorOpenPct: 0,
            pumpPressure: 0,
            flowRate: 0,
            sweeteningActive: false,
            networkFilled: false,
            sweeteningProgress: 0,
            fuelSource: 'tk_od_center',
            carter: { vol: 0, max: 0.08 },
            loConsumption: 0.0000333333
        },
        winch: { isActive: false, direction: 'STOP', hydReservoir: { vol: 0.4, max: 0.4 } },
        chiller: { isOn: false, setTemp: 22, actualTemp: 30, power: 0 },
        air_ps: {
            name: "Sistema de Ar de Acoplamento BB",
            compressorName: "Compressor de Ar BB",
            mode: 'AUTO',
            isRunning: false,
            bottlePressure: 14,
            bottleMax: 14,
            ...
            chargeRate: 1.2,
            standbyLeak: 0.03,
            controlRechargeRate: 0.8,
            couplingConsumption: 1.4,
            compressorLoadKw: 12
        },
        air_sb: {
            name: "Sistema de Ar de Acoplamento BE",
            compressorName: "Compressor de Ar BE",
            mode: 'AUTO',
            isRunning: false,
            bottlePressure: 14,
            bottleMax: 14,
...
const VESSEL_HYDROSTATICS = {
    ...
    fixedEquipment: [
        ...
        { name: 'FiFi One', mass: 7.5, side: 'center', longitudinal: 'mid' },
...
VESSEL_HYDROSTATICS.fixedEquipment = [
    ...
    { name: 'FiFi One', mass: 7.5, side: 'center', longitudinal: 'mid', yArm: 1.1 },
